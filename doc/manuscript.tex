...
The process of gene transfer does not necessarily move whole genes from one
species to another \citep[e.g.,][]{Chan2009}, and we observed that units of
recombining gene transfer do not correspond to single genes in their entirety
(Table S\ref{tab:genes-transfer}). In some cases, only parts of a gene were
inferred to have been transferred, for instance, transfer from SPY1 to SDE1 was
inferred for 29\% of the aspartyl-tRNA synthetase gene (see also Figure
S\ref{fig:muts}). In other cases, the inferred transfer units cover sets of as
much as eight adjacent genes.  Not only parts of genes could be transferred via
recombination, but a group of genes could also be moved together. Of the genes
listed in Table S\ref{tab:genes-transfer} there were 12 groups of genes that
were consecutive.  While transfer fragments of genes often covered two genes,
there were transfer fragments that covered eight genes together. Loci from
SpyM3\_1512 to SpyM3\_1525 were inferred to be transferred from SDE2 to SDD.

\section{Discussions}

Closely related bacterial species were investigated here to better understand
gene transfer processes. Two complementary methods were employed to study
recombining and non-recombining gene transfers. By discriminating the two
...
% WITH ONLY TREE-TOPOLOGY CHANGING RECOMBINANT EDGES.} 
...
% When we
% performed simulations which much longer blocks (10000 bp), \texttt{ClonalOrigin}
% was able to estimate the average recombinant tract length accurately (data not
% shown).  
% FIXME: Show this result of 10,000 blocks.
...
%=============================================================================
% Figure 1. Heat maps of recombining gene transfer (Add horizontal gene transfer)
\begin{figure}
...
\includegraphics[width=5in]{figures/heatmap-hgtedge}
\end{center}
\vspace{-1.2in}
...
%=============================================================================
% Table S3. ClonalOrigin's 1st stage result.
\begin{table}
...
%=============================================================================
% Figure S1: Mauve alignment
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{figures/mauve.pdf}
\end{center}
\vspace{-1.2in}
...
%=============================================================================
% Figure S: Scatter plot of rho and log(delta)
\begin{figure}
\begin{center}
...
%=============================================================================
% Figure S5. A Recombinant Tree of ClonalOrigin Model
\begin{figure}
...
%=============================================================================
% Figure S6: View of UCSC genome browser for bacterial gene transfer.
\begin{figure}
\includegraphics[scale=0.6]{figures/ucsc}
...
\includegraphics[width=5in]{figures/heatmap-recedge-mowgli}
\end{center}
\vspace{-1.2in}
