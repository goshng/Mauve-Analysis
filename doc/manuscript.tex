...
only in the core genome but also in the pan genome, which made the analysis
...
% More interpretations about Mawgli analysis of function categories?
% Why transposases?
...
\texttt{Limitation of ClonalOrigin: inability of inferring recombinant edges}

\texttt{Need of a new model with asymmetry of gene transfer}

\texttt{Need of more SDE genomes}
...
obtained by \texttt{ClonalOrigin} in a scenario similar to one from the real 
data set.  We used a
simulation feature of \texttt{ClonalOrigin} to simulate the process of mutation
and recombination across the five species 
...
tree}, which will be defined in a moment, 
was not detailed in the user guide at the time when we used
...
with \textit{recombinant edges}.  A recombinant edge connect two species tree
branches.  Each recombinant edge is defined by the time
...
certain types were better indicators of recombination events than others.
...
intensity.  
% The tree topologies changes would be correlated with recombination
...
bacterial genomes.  Each of the recombinant trees was used to simulate the
Jukes-Cantor model for DNA sequence evolution to create 274 blocks of
alignments.  The block lengths configuration was the same as that of the blocks
used in the analysis of the five genomes.  The mean of the ten estimates of the
recombinant tract length was significantly higher than the true value of (919 bp
versus 744 bp) whereas the values of the mutation and recombination rates were
accurately estimated (Table S\ref{tab:sim-three-population-parameters}).
Recombinant tract lengths were known to be difficult to estimate from relatively
...
Because of the two-stage Bayesian method we first sampled ten recombinant trees
given the mutation rate, recombination rate, and tract length, and then created
ten independent simulated data sets with the Jukes-Cantor model for DNA sequence
evolution using each of the recombinant trees. This consisted of 100 replicates
of data sets.  Figure S\ref{fig:h1} shows the observed count of each recombinant
...
of the true intensity. For this purpose, we artificially annotated our synthetic
...
implied by the recombinant tree used in simulation 
(Pearson's correlation coefficient of 0.63 and Figure S\ref{fig:ri1}). 
...
%=============================================================================
% Table SXXX. Simulation study for the three population parameters.
\begin{table}
...
% Figure S12: 
\begin{figure}
\subfloat[]{\includegraphics[scale=0.5]{figures/h3-R-ratio-topology-changing}}
\subfloat[]{\includegraphics[scale=0.5]{figures/h3-R-ratio-not-topology-changing}}
