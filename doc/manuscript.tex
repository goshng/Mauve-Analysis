...
\includegraphics[scale=0.4]{figures/h3-R-ratio-topology-changing}

\includegraphics[scale=0.4]{figures/h3-R-ratio-not-topology-changing}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.5]{figures/scatter-plot-parameter-1\lyxdot out\lyxdot theta}

\includegraphics[scale=0.5]{figures/scatter-plot-parameter-1\lyxdot out\lyxdot rho}

\includegraphics[scale=0.5]{figures/scatter-plot-parameter-1\lyxdot out\lyxdot delta}
\end{center}
\caption{
