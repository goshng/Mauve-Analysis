...
not correspond to single genes in their entirety
(Table S\ref{tab:genes-transfer}). In some cases, only parts of 
...
%=============================================================================
% Figure XXX: View of UCSC genome browser for bacterial gene transfer.
\begin{figure}
