...
#
#   File: plot-import-ratio-jcvi-role.pl
#   Date: 2011-02-25
#   Version: 1.0.0
#
#   Usage:
#      perl plot-import-ratio-jcvi-role.pl [options]
#
#      Try 'perl plot-import-ratio-jcvi-role.pl -h' for more information.
#
#   Purpose: plot-import-ratio-jcvi-role.pl help you to plot boxplots
#            using combine-import-ratio-jcvi-role.txt.
#
...
my $VERSION = 'plot-import-ratio-jcvi-role.pl 1.0.0';
...
plot-import-ratio-jcvi-role.pl - Combine import ratio and jcvi role files.

=head1 VERSION

plot-import-ratio-jcvi-role.pl 1.0.0

=head1 SYNOPSIS

perl plot-import-ratio-jcvi-role.pl.pl [-h] [-help] [-version] [-man] [-verbose] 
  [-importRatio import_ratio_file]
  [-jcviRole jcvi_role_file]

=head1 DESCRIPTION

plot-import-ratio-jcvi-role.pl help you to combine import ratio and jcvi role
files.
...
com repository so that I can make plot-import-ratio-jcvi-role.pl better.
...
sub printError {
    my $msg = shift;
    print STDERR "ERROR: ".$msg.".\n\nTry \'plot-import-ratio-jcvi-role.pl -h\' for more information.\nExit program.\n";
    exit(0);
}
